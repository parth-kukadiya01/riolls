            ...
            <section className={styles.statsSection}>
                <div className={styles.statsGrid}>
                    {[
                        ...
                        ...(stats.wouldRecommendPercent != null ? [{ label: 'Would Recommend', value: `${stats.wouldRecommendPercent}%`, unit: '' }] : []),
                        ...(stats.verifiedPercent != null ? [{ label: 'Verified Purchases', value: `${stats.verifiedPercent}%`, unit: '' }] : []),
                    ].map(s => (
