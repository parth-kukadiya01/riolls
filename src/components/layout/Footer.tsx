    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.grid}>
                <div className={styles.col}>
                    <button
                        ...
                        onClick={() => setOpenSection(openSection === 'customer' ? 'none' : 'customer')}
                    >
                        Customer Care
                        <span className={`${styles.accordionIcon} ${openSection === 'customer' ? styles.iconOpen : ''}`}>
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M6 9l6 6 6-6" /></svg>
                        </span>
                    </button>
                    <div className={`${styles.accordionContent} ${openSection === 'customer' ? styles.contentOpen : ''}`}>
                ...
                <div className={styles.col}>
                    <button
                        className={styles.accordionHeader}
                        onClick={() => setOpenSection(openSection === 'client' ? 'none' : 'client')}
                    >
                        Client Services
                        <span className={`${styles.accordionIcon} ${openSection === 'client' ? styles.iconOpen : ''}`}>
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M6 9l6 6 6-6" /></svg>
                        </span>
                    </button>
                    <div className={`${styles.accordionContent} ${openSection === 'client' ? styles.contentOpen : ''}`}>
                        <Link href="/bespoke">Bespoke Jewellery</Link>
                ...
                <div className={styles.col}>
                    <button
                        className={styles.accordionHeader}
                        onClick={() => setOpenSection(openSection === 'company' ? 'none' : 'company')}
                    >
                        Our Company
                        <span className={`${styles.accordionIcon} ${openSection === 'company' ? styles.iconOpen : ''}`}>
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M6 9l6 6 6-6" /></svg>
                        </span>
                    </button>
                    <div className={`${styles.accordionContent} ${openSection === 'company' ? styles.contentOpen : ''}`}>
                ...
                <div className={styles.col}>
                    <button
                        className={styles.accordionHeader}
                        onClick={() => setOpenSection(openSection === 'legal' ? 'none' : 'legal')}
                    >
                        Legal &amp; Privacy
                        <span className={`${styles.accordionIcon} ${openSection === 'legal' ? styles.iconOpen : ''}`}>
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M6 9l6 6 6-6" /></svg>
                        </span>
                    </button>
                    <div className={`${styles.accordionContent} ${openSection === 'legal' ? styles.contentOpen : ''}`}>
            ...
            <div className={styles.bottomSection}>
                <div className={styles.shippingCenter}>
                    <span className={styles.shippingText}>Shipping to</span>
                    <Link href="#" className={styles.shippingLink}>India</Link>
                </div>
            </div>
            {/* Bottom legal bar */}
            <div className={styles.legal}>
                <div className={styles.socials}>
                    ...
                    <a href="https://wa.me/message/CNVYZ7P7GP3SN1?text=Hello" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className={styles.socialIcon}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z" />
                        </svg>
                    </a>
                </div>
                <span className={styles.copyright}>© Riolls Jewels IN 2026</span>
            </div>
        </footer>
    );
}
